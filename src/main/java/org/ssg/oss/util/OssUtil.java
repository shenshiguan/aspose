...
import org.ssg.utils.DateTimeUtil;
...
public class OssUtil {
	...
	public static void main(String[] args) {
		downFile("time-1121", "D:\\oss\\", "abcdef.pdf");
	...
	// final static String ACCESSKEYID = ConfigUtil.get("oss.accessKeyId",
	// "LTAI3o1OZHRkwtpw");
	// final static String ACCESSKEYSECRET =
	// ConfigUtil.get("oss.accessKeySecret", "ZyXeu0KourFVd48owjcDAovN9uy7rq");
	// final static String ENDPOINT = ConfigUtil.get("oss.out.url",
	// "https://oss-cn-beijing.aliyuncs.com");
	// final static String BUCKETNAME = ConfigUtil.get("oss.bucket.name",
	// "ekuakao");
	 ...
	 * @throws
	 */
	public static void downFile(String key, String filePath, String fileName) {
		...
		// 下载object到文件
		ossClient.getObject(new GetObjectRequest(BUCKETNAME, key), new File(filePath + fileName));
		// 关闭client
		ossClient.shutdown();
	}
	...
	public static String getObjectUrl(String key, int days) {
		try {
			...
			// 设置过期时间
			Date expiration = DateTimeUtil.dayAdd(new Date(), days);
